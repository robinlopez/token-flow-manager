...
// 0.1.6 has no snapshot of its own: it shipped without a docs cut, so its docs
// are the frozen 0.1.5 ones.
const VERSIONS = [
  { version: '0.1.7', title: '0.1.7 (latest)', aliases: ['latest'], en: 'docs/en', fr: 'docs/fr' },
