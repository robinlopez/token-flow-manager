...
- **[Starter templates](templates.md)**: no project yet? One slide away, scaffold Tailwind
  CSS v4, Material Design 3, Semantic Functional DS or the Simple Design System.
